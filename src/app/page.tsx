      ...
      <main className="flex max-w-md flex-col items-center gap-8 text-center">
        ...
        <div className="flex w-full flex-col gap-3">
          <button
            ...
            className="flex h-12 items-center justify-center gap-3 rounded-xl border border-border bg-white font-medium text-foreground shadow-sm transition-colors hover:bg-muted dark:bg-[var(--color-neutral-900)] dark:hover:bg-[var(--color-neutral-800)]"
          >
